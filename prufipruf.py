...
# order = Order(1,"AB123",("12122018","14122018"),"magga@gmail.com","false")

serv.move_to_past("vanessagigi@gmail.com")

#print(serv.get_list_of_past_orders())
# order = Order(5,"ABCDe",("05052018","06052018"),"palina@gmail.com","false")
# serv.log_order(order)
